...
console.log("GREENFIELD_RPC_URL", import.meta.env.VITE_GREENFIELD_RPC_URL);

const greenFieldChain = {
  id: import.meta.env.VITE_GREEN_CHAIN_ID,
  network: "greenfield",
  rpcUrls: {
    default: {
      http: [import.meta.env.VITE_GREENFIELD_RPC_URL],
    },
    public: {
      http: [import.meta.env.VITE_GREENFIELD_RPC_URL],
    },
...
const bscChain = {
  id: import.meta.env.VITE_BSC_CHAIN_ID,
  name: "BSC",
  network: "QA - bsc smart chain",
  rpcUrls: {
    default: {
      http: [import.meta.env.VITE_BSC_RPC_URL],
    },
    public: {
      http: [import.meta.env.VITE_BSC_RPC_URL],
    },
...
const RainbowTrustWalletConnector = ({ chains, projectId }) => ({
  id: "_trust-wallet",
  name: "Trust Wallet",
